...
// const $footerDecorateBlock = document.querySelector('.footer-decorate__block');
// const $footerText = document.querySelector('.footer__text:last-child');
// const $footerBottom = document.querySelector('.footer__bottom');

// breakpointHelper.listen({ name: 'xs', useMax: true }, ({ matches }) => {
// 	if (matches) {
// 		$footerText.classList.add('footer-decorate__text');
// 		$footerDecorateBlock.insertAdjacentElement('beforeend', $footerText);
// 	} else {
// 		$footerText.classList.remove('footer-decorate__text');
// 		$footerBottom.insertAdjacentElement('beforeend', $footerText);
// 	}
// });
...
/* harmony import */ var _helpers_breakpoints__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/breakpoints */ "./src/js/helpers/breakpoints.js");
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");


var formButton = document.querySelector('[data-form-btn]');
var form = document.querySelector('[data-form]');
_helpers_breakpoints__WEBPACK_IMPORTED_MODULE_0__.breakpointHelper.listen({
  name: 'md',
  useMax: true
}, function (_ref) {
...
(0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.querySelector('[type="tel"]'), {
  mask: '{+7}(000)000-00-00'
});
document.querySelector('.form-file').addEventListener('change', function (e) {
  var $fileNameInput = this.querySelector('.form-file__name');
...
/* harmony export */   "breakpointHelper": function() { return /* binding */ breakpointHelper; }
/* harmony export */ });
/* harmony import */ var breakpoint_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! breakpoint-helper */ "./node_modules/breakpoint-helper/dist/breakpoint-helper.module.js");

var breakpointHelper = (0,breakpoint_helper__WEBPACK_IMPORTED_MODULE_0__["default"])({
  xs: '320px',
  md: '768px',
  xl: '1260px'
});
...
/***/ "./src/js/helpers/browser-check.js":
/*!*****************************************!*\
  !*** ./src/js/helpers/browser-check.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _breakpoints__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./breakpoints */ "./src/js/helpers/breakpoints.js");
...
var getCurrentBreakpointSize = function getCurrentBreakpointSize() {
  var breakpoints = _breakpoints__WEBPACK_IMPORTED_MODULE_0__.breakpointHelper.getBreakpoints();
  return parseInt(Object.entries(breakpoints).reverse().find(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 1),
      name = _ref2[0];
    return _breakpoints__WEBPACK_IMPORTED_MODULE_0__.breakpointHelper.isMatching(name);
  })[1]);
};
var zoomingElement = function zoomingElement() {
  var elementsForZooming = document.querySelectorAll('[data-zooming]');
  elementsForZooming.forEach(function (el) {
    var height = "".concat(el.children[0].getBoundingClientRect().height, "px");
    el.style.height = height;
  });
};
var calculateZoomFactor = function calculateZoomFactor() {
  var root = document.querySelector(':root');
  var currentBreakpointSize = getCurrentBreakpointSize();
  var zoomFactor = (window.innerWidth / currentBreakpointSize).toFixed(3);
...
/* harmony import */ var _helpers_breakpoints__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/breakpoints */ "./src/js/helpers/breakpoints.js");
var _breakpoints;
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var breakpoints = _helpers_breakpoints__WEBPACK_IMPORTED_MODULE_1__.breakpointHelper.getBreakpoints();
// import 'swiper/css';
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.jury-slider', {
  spaceBetween: 10,
  slidesPerView: 1.1,
  loop: true,
  grabCursor: true,
  ...
  }, _defineProperty(_breakpoints, Number.parseInt(breakpoints.md), {
    spaceBetween: 20,
    slidesPerView: 2.2
...
var burgerMenuHTML = document.querySelector('[data-burger]');
// const menu = document.querySelector('[data-menu]');
// const header = document.querySelector('[data-header]');
var navListHTML = document.querySelector('[data-nav]').cloneNode(true);
var menuContentHTML = document.querySelector('.menu__content');
burgerMenuHTML.addEventListener('click', function (_ref) {
  var currentTarget = _ref.currentTarget;
  currentTarget.classList.toggle('burger--active');
  var isMenuOpened = currentTarget.classList.contains('burger--active');
...
var $questionButton = document.querySelector('.question-card__button');
var $questionInner = document.querySelector('.question-card__inner');
_helpers_breakpoints__WEBPACK_IMPORTED_MODULE_0__.breakpointHelper.listen({
  name: 'xl',
  useMax: true
}, function (_ref) {
...
var cloneTextFromLine = function cloneTextFromLine() {
  runningLines.forEach(function (runningLine) {
    var textLine = runningLine.children[0];
    for (var i = 0; i < 3; i++) {
...
runningLines.forEach(function (runningLine) {
  Array.from(runningLine.children).forEach(function (el) {
...
// import 'swiper/css';
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.timeline-slider', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
  grabCursor: true,
  slidesPerView: 'auto',
  spaceBetween: 40,
...
/* harmony export */ });
var e={};function t(){return e}function n(t,r){if(void 0===r&&(r=!1),Array.isArray(t)){var i=t[1];return n(t[0])+" and "+n(i,!0)}var a=e[t];if(void 0===a)throw new Error('"'+t+'" does not seem to be a breakpoint name');if(r){var o=parseFloat(a,10),c=a.replace(o,"");return"(max-width: "+(o-("em"===c?.0635:1))+c+")"}return"(min-width: "+a+")"}function r(e,t){return void 0===t&&(t=!1),window.matchMedia(n(e,t)).matches}function i(e,t){var r=null,i=e.immediate,a={name:e.name,useMax:e.useMax||!1,immediate:void 0===i||i};function o(){r="string"==typeof e||Array.isArray(e)?window.matchMedia(n(e)):window.matchMedia(n(a.name,a.useMax)),a.immediate&&t(r);try{r.addEventListener("change",t)}catch(e){r.addListener(t)}}return o(),{on:o,off:function(){if(r){try{r.removeEventListener("change",t)}catch(e){r.removeListener(t)}r=null}}}}function a(t,n){void 0===n&&(n={});var a=Object.keys(e),o=[],c=a;if(0!==a.length){var u=n.immediate,s=n.listenTo,f={useMax:n.useMax||!1,immediate:void 0===u||u};s&&(c=s.sort(function(t,n){return parseInt(e[t],10)-parseInt(e[n],10)}));var d=function(){t(function(e,t){void 0===t&&(t=!1);var n=[];return e.forEach(function(e){r(e,t)&&n.push(e)}),t?n:n.reverse()}(c,f.useMax))};return m(),{on:m,off:function(){o.length&&(o.forEach(function(e){return e.off()}),o=[])}}}function m(){c.forEach(function(e){var t=i({name:e,useMax:f.useMax,immediate:!1},d);o.push(t)}),f.immediate&&d()}}/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(o){var c;if(void 0===o&&(o={}),"string"==typeof o&&"meta"===o?e=function(){var e=document.createElement("meta");e.classList.add("breakpoint-helper"),document.getElementsByTagName("head")[0].appendChild(e);var t=window.getComputedStyle(e).getPropertyValue("font-family");return t.length<=0?{}:(t=t.replace(/'|"/g,"").split("&")).reduce(function(e,t){var n=t.split("=");return e[n[0]]=n[1],e},{})}():"string"==typeof o&&"custom"===o?(c=[].concat(document.styleSheets).filter(function(e){return-1!==e.href.indexOf(window.location.origin)}),e=[].concat(c).reduce(function(e,t){return[].concat(t.cssRules).forEach(function(t){":root"===t.selectorText&&t.cssText.split("{")[1].replace("}","").split(";").forEach(function(t){var n=t.split(":"),r=n[0],i=n[1];-1!==r.indexOf("--bph-")&&(e[r.replace("--bph-","").trim()]=i.trim())})}),e},{})):e=o,0===Object.keys(e).length)throw new Error("No breakpoints defined");return{getBreakpoints:t,getMediaQuery:n,isMatching:r,listen:i,listenAll:a}}
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_zoom_factor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/zoom-factor */ "./src/js/helpers/zoom-factor.js");
...
/* harmony import */ var _running_line__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./running-line */ "./src/js/running-line.js");
/* harmony import */ var _running_line__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_running_line__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _jury__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./jury */ "./src/js/jury.js");
/* harmony import */ var _questions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./questions */ "./src/js/questions.js");
/* harmony import */ var _timeline__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./timeline */ "./src/js/timeline.js");
/* harmony import */ var _helpers_browser_check__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./helpers/browser-check */ "./src/js/helpers/browser-check.js");
...
var browserName = (0,_helpers_browser_check__WEBPACK_IMPORTED_MODULE_8__.detectBrowser)();
if (browserName) {
